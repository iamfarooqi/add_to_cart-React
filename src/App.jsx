...
function App() {
  ...
  function add(e) {
    ...
    var cartProducts = cart.find((cart) => cart.id === e.id)
...
//     var additem = cart.find((cart) => cart.id === e.id)
//     // console.log("result ", result)   
//     if (additem === ) {
//         setCart([...cart, e])
//     } else {
    ...
    <div>
      ...
      {cart.map((e, index) => (
        ...
        <div key={index}>
          ...
          {/* <p><button onClick={() => subitem(e)}>-</button></p>  */}
        <p> <button onClick={() => additem(e)} >+</button>  </p>
